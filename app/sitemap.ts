...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPaths = ["", "/services", "/prices", "/prices-waste", "/prices-clean", "/prices-deep_clean", "/prices-left", "/prices-tidyup", "/livingclean-price", "/reviews", "/portfolio", "/regions", "/estimate", "/company", "/privacy", "/terms", "/refund-policy"];
