...
export const legalDocuments = {
  privacy: {
    ...
    sections: [
      ...
      { title: "3. 보유 및 이용 기간", paragraphs: ["상담 정보와 현장 사진의 실제 보유기간은 대표자 승인 전이며, 확정 전에는 운영 배포를 진행하지 않습니다. 관계 법령상 보존 의무가 있는 정보는 해당 기간 동안 별도 보관할 수 있습니다."] },
      { title: "4. 제3자 제공과 처리위탁", paragraphs: ["현재 제3자 판매·광고 제공은 예정하지 않습니다. 운영 시 사용하는 호스팅, 데이터베이스, 비공개 파일 저장소, 이메일 전송 사업자와 위탁 범위를 확정해 이 방침에 공개합니다."] },
  ...
  refund: {
    ...
    sections: [
      ...
      { title: "2. 예약 확정 후 변경·취소", paragraphs: ["예약금, 취소 시점별 비용, 일정 변경 가능 횟수는 실제 운영 기준 확정 전입니다. 계약 전 견적서 또는 별도 계약서에 기준을 명시하고 동의를 받습니다."] },
